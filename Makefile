...
help: ## Show this interactive help banner
	...
	@echo -e "  make up                           # Boot container mesh in background (Podman default)"
	...
	@echo -e "  make migration-create MSG=\"...\"   # Generate new autogenerated migration"
	@echo -e "  make seed                         # Seed initial superuser into database"
	@echo -e "  make frontend-sync                # Export OpenAPI spec & compile TypeScript SDK"
...
health: ## Perform HTTP health check against local Litestar instance
	...
	@curl -fsS http://localhost:8000/docs/scalar >/dev/null && echo -e "$(GREEN)✅ Backend is healthy & serving OpenAPI docs$(NC)" || echo -e "$(RED)❌ Backend not responding$(NC)"
